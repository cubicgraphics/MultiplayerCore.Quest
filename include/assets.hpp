...
namespace IncludedAssets {
	...
	DECLARE_FILE(LoadingIndicator_bsml)
	DECLARE_FILE(MissingReq_png)
	DECLARE_FILE(MissingSprite_png)
	DECLARE_FILE(MissingSuggestion_png)
	DECLARE_FILE(RequirementsButton_bsml)
	DECLARE_FILE(RequirementsUI_bsml)
	DECLARE_FILE(Warning_png)
